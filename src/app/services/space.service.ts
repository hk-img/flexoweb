...
export class SpaceService {
	...
	getAllSpacesCities = environment.apiUrl + '/api/v1/spaces/getAllSpacesCities';
	...
	getAllSpacesCitiess(spaceType: any) {
		return this.http.get(this.getAllSpacesCities + `?spaceType=${spaceType}`);
	}
}
