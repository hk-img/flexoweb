...
import { WorkspaceRatingReviewListComponent } from './workspace-rating-review-list.component';
...
const routes: Routes = [
  { path: '', component: WorkspaceRatingReviewListComponent },
];

@NgModule({
    declarations: [WorkspaceRatingReviewListComponent],
    imports: [
        CommonModule,
        FormsModule,
        SlickCarouselModule,
...
export class WorkspaceRatingReviewListModule {}